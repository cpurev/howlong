...
<template>  
  ...
  <main>
    ...
    <Transition appear
      name="fade-up">
        <ShakeButton text="Resume" link="https://drive.google.com/file/d/1p_oI140qzwjDMW-zNRVfYdI1e23R6yKA/view?usp=sharing"/>
    </Transition>
      </section>
    <section id="about">
        <div class="profile" >
            ...
            <div class="about-me">
              ...
              <p>Areas in CS that I'm most intrested in:</p>
            <ul class="interests">
